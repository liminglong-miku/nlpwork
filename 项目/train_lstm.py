...
class Consumer(threading.Thread):
    def __init__(self, queue, step, pid, voc_size, valid_data_flow):
        ...
        self.train_in_seq = tf.compat.v1.placeholder(tf.int32, shape=[dataflow.batch_size, None], name='in_seq')
        self.train_in_seq_len = tf.compat.v1.placeholder(tf.int32, shape=[dataflow.batch_size], name='in_seq_len')
        self.train_target_seq = tf.compat.v1.placeholder(tf.int32, shape=[dataflow.batch_size, None], name='target_seq')
        self.train_target_seq_len = tf.compat.v1.placeholder(tf.int32, shape=[dataflow.batch_size], name='target_seq_len')
